...
public class Special5FinderTest extends BaseCliqueFinderTest {


    public static final int NODE_COUNT = 5

    public Special5FinderTest(MaxCliqueFinder finder) {
        super(finder);
    }
    ...
    public static Collection params() {
        return [
                [new Special5MaxCliqueFinder<String>()] as Object[],
